import { FaBook, FaClock, FaComment, FaReadme, FaThList } from "react-icons/fa";
    ...
    <div className="col-span-12 lg:col-span-4 lg:space-y-2 space-y-2 rounded-md border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md">
      ...
      <div className="lg:space-y-4 space-y-2 p-2">
        ...
        <div className="flex items-center justify-between">
          <div className="lg:text-[16px] text-sm text-gray-500 font-bold italic border border-gray-400 rounded-full shadow-sm lg:py-1 py-[4px] lg:px-2 px-1 flex items-center lg:space-x-2 space-x-1">
            <span>
              <FaReadme />
            </span>
            <span>Read in:</span>
...
export default RelatedBlogPostsCard;
